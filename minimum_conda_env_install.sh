...
mamba install -c conda-forge -c bioconda r-base r-devtools r-pracma r-r.utils r-argparse r-lme4 r-lmertest r-data.table r-reticulate r-plyr bioconductor-bsgenome.hsapiens.1000genomes.hs37d5 bx-python bioconductor-bsgenome.hsapiens.ucsc.hg19 ucsc-bigwigaverageoverbed
